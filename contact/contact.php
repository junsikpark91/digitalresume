...
$sendToEmail = 'junsikpark91@gmail.com';
$sendToName = 'Name';
...
try
{
    ...
    $emailTextHtml .= "<h3>New message from the Jun Sik Park Resume Website:</h3><hr>";
    $emailTextHtml .= "<table>";
    ...
    $emailTextHtml .= "<p>Have a great day!<br><br>Sincerely,<br><br>Jun Sik Park</p>";
